...
(module ROOT/CPhCWc9MMHQV/CPTAGGehn7eP/CPHXAGdqGGDF/CPJdrhmNbenC/CPP3pktxNiVc/CP6KwDyj8wHg racket 
  (require rackunit 'CODEPOD "../../../../../../../ROOT/CPhCWc9MMHQV/CPTAGGehn7eP/CPVHDqKYNUwz/main.rkt")
  (provide triangular mytext pin-over-cc save-file sincos->theta angle-find maybe-find
